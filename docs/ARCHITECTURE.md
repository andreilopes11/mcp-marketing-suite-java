...
### 1. Controllers Layer
- **MarketingController**: Handles HTTP requests, validates input, returns responses
...
- Simulates MCP server functionality with in-memory storage
